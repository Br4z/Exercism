...
// The function should return true if Pac-Man is touching a ghost and does not
// have a power pellet active.
...
// The function should return true if Pac-Man has eaten all of the dots and has
// not lost
